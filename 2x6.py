...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='data/2x6')
    ...
    parser.add_argument('--n_bidder', type=int, default=2)
    ...
    #Rgt
    parser.add_argument('--lamb_r', type=float, default=2)
    parser.add_argument('--lamb_r_update_freq', type=int, default=6)
    parser.add_argument('--rho_r', type=float, default=1)#初始惩罚项ρ=1
    parser.add_argument('--rho_r_update_freq', type=int, default=2)
    parser.add_argument('--delta_rho_r', type=float, default=3)#ρ每次增大5
    #Ir
    parser.add_argument('--lamb_i', type=float, default=2)
    parser.add_argument('--lamb_i_update_freq', type=int, default=6)
    parser.add_argument('--rho_i', type=float, default=1)
    parser.add_argument('--rho_i_update_freq', type=int, default=2)
    parser.add_argument('--delta_rho_i', type=float, default=2)
    #Bf

    parser.add_argument('--lamb_b', type=float, default=2)
    parser.add_argument('--lamb_b_update_freq', type=int, default=6)
    parser.add_argument('--rho_b', type=float, default=1)
    parser.add_argument('--rho_b_update_freq', type=int, default=2)
    parser.add_argument('--delta_rho_b', type=float, default=2)
