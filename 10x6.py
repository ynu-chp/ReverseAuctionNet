...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='data/10x6')
    ...
    parser.add_argument('--n_bidder', type=int, default=10)
    ...
    parser.add_argument('--rho_i_update_freq', type=int, default=6)
    ...
    parser.add_argument('--rho_b_update_freq', type=int, default=8)
