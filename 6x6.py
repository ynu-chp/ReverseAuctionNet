...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='data/6x6')
    ...
    parser.add_argument('--rho_i_update_freq', type=int, default=3)
    parser.add_argument('--delta_rho_i', type=float, default=2)
    #Bf
    parser.add_argument('--lamb_b', type=float, default=0.5)
    parser.add_argument('--lamb_b_update_freq', type=int, default=6)
    parser.add_argument('--rho_b', type=float, default=0.5)
