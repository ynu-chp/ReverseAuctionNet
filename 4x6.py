...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='data/4x6')
    ...
    parser.add_argument('--rho_b', type=float, default=1)#初始惩罚项ρ=1
    parser.add_argument('--rho_b_update_freq', type=int, default=5)
    parser.add_argument('--delta_rho_b', type=float, default=2)#ρ每次增大5
